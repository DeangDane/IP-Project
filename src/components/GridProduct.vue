<template>
  <div class="gridPro">
    <div class="btns">
      ...
      <div class="favorite" id="favorite" @click="toggleFavoriteColor()">
        <svg width="22px" height="22px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
          <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
          <g id="SVGRepo_iconCarrier">
            <path fill-rule="evenodd" clip-rule="evenodd" id="stroke"
    ...
    <div class="Image" @click="goToProDetails()"><img :src="image" class="image" /></div>

    <div class="detail" @click="goToProDetails()">
      <div class="proName">
        <h3>{{ proName }}</h3>
      </div>
      ...
      <div class="price">
        ...
        <h5 v-if="label === 'PRO'" class="rawPrice">${{ rawPrice }}</h5>
        <h5 v-if="label === 'PRO'" class="percent"> {{ discount }}% off</h5>
      </div>
    </div>
